...
public class StreamAPI_2_중간처리2_map {
	...
	public static void main(String[] args) {
		...
		//람다표현식
		list.stream().map(t->t.score).forEach(System.out::println);
		System.out.println();
		...
		//가공2. score값만 출력 - mapToInt이용 -> return 타입은 무조건 int
		//익명클래스
		...
		//람다표현식
		list.stream().mapToInt(value->value.getScore()).forEach(System.out::println);
		System.out.println();
