...
public class FunctionTest {
	...
	public static void main(String[] args) {
		...
		int n = f.apply("Anonymous");
		System.out.println("문자열 길이:" +n);
		
		//람다표현식
		Function<String, Integer> f2 = t -> t.length();
		int n2 = f2.apply("Lambda");
		System.out.println("문자열 길이:"+n2);
		...
		String sub2 = k2.apply("WorldHello", 5);
		System.out.println("부분열:"+sub2);
